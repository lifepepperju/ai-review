...
> 🏢 **社内配布版**: セットアップ手順は [`SETUP.html`](SETUP.html) を参照してください（Claude Codeスキル／macOS右クリック連携の2種類）。本体は [ykitaza/ai-review-comments](https://github.com/ykitaza/ai-review-comments)（MIT License）です。
